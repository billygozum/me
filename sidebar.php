...
if (!is_single()) {
    $class = "sidebar-fixed";
} elseif(is_single() && !(isset($rscard_options['author_image']['url']) && $rscard_options['author_image']['url'] != '' && isset($rscard_options['header-image'])) && isset($rscard_options['header-image']) && $rscard_options['header-image']['url'] != '') {
