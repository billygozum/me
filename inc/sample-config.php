<?php
    ...
    $args = array(
        ...
        'menu_title'           => esc_html__( 'Rs-Card Options', 'rs-card' ),
        'page_title'           => esc_html__( 'Rs-Card Options', 'rs-card' ),
	...
	Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Google Api Options', 'rs-card' ),
        'id'               => 'api-opt',
        'subsection'       => true,
        'customizer_width' => '450px',
        'fields'           => array(
	...
	if(isset($rscard_options['fontapi-key']) && $rscard_options['fontapi-key']!==''){
		$key = esc_url($rscard_options['fontapi-key']);
	}else{
    ...
    Redux::setSection( $opt_name, array(
        'title'      => esc_html__( 'Font Family Settings', 'rs-card' ),
