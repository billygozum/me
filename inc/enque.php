...
function rscard_scripts() {
    ...
    wp_enqueue_style( 'map-icons', get_template_directory_uri() . '/fonts/map-icons/css/map-icons.min.css', array() );
    ...
    wp_enqueue_script( 'fancybox', get_template_directory_uri().'/js/plugins/jquery.fancybox/jquery.fancybox.js','','',true );
    wp_enqueue_script( 'fancybox-media', get_template_directory_uri().'/js/plugins/jquery.fancybox/helpers/jquery.fancybox-media.js','','',true );
...
{	
    ...
    if(($rscard_options['color-scheme'] === '') and ($rscard_options['primary-color']!=='')){
        ...
        $output.="
			...
			.theme-color-{$color_class} .pagination .page-numbers.current,
			.theme-color-{$color_class} .pagination .page-numbers.current:hover,
			.theme-color-{$color_class} .pagination .page-numbers:active,
			.theme-color-{$color_class} .pagination .page-numbers.next:active,
			.theme-color-{$color_class} .pagination .page-numbers.prev:active,
