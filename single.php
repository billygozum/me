                    ...
                    <article <?php post_class();?>>
                        <div class="post-media">
                            <?php switch ($post_type) {
                                case false:
                                    if($image = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'rs-card-single-post', false)):
                                    ?>
                                ...
                                case 'gallery':
                                    ...
                                    <ul class="post-slider">
                                        <?php foreach($slider_images as $image):?>
                                            <li><img src="<?php echo esc_url($image['sizes']['rs-card-single-post']);?>" alt="<?php echo esc_attr($image['alt']);?>"/></li>
                                        <?php endforeach;?>
                                    </ul>
